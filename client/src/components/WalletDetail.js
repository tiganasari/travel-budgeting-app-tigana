  ...
  useEffect(() => {
    ...
    return (
        ...
        <li className="transaction" key={i.id} onClick={() => onSelectItem(i.id)}>
          <button className="button-list" key={id} onClick={() => onSelectTrans()}> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="bi bi-trash delete-icon trans-icon" viewBox="0 0 16 16">
